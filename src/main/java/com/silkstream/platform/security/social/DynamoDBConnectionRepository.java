...
class DynamoDBConnectionRepository implements ConnectionRepository {

	private final String userId;
	private final DynamoDBConnectionService connService;
	private final ConnectionFactoryLocator connectionFactoryLocator;

	public DynamoDBConnectionRepository(String userId,
										DynamoDBConnectionService connectionService,
